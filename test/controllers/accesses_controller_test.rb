...
class AccessesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post accesses_url, params: { access: { app_id: @access.app_id, auto_login: @access.auto_login, login: @access.login, menu_position: @access.menu_position, password: @access.password, user_id: @access.user_id } }
  #   end
  ...
  #   patch access_url(@access), params: { access: { app_id: @access.app_id, auto_login: @access.auto_login, login: @access.login, menu_position: @access.menu_position, password: @access.password, user_id: @access.user_id } }
